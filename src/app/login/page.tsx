  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-black text-zinc-100 font-sans antialiased">
      ...
      <div className="flex flex-col justify-center px-8 sm:px-16 lg:px-24 xl:px-32 relative z-10">
        ...
        <Link
          href="/"
          className="absolute top-10 left-8 sm:left-16 lg:left-24 text-xl font-bold tracking-tighter"
        >
          ThumbAI
        </Link>
        ...
        <div className="max-w-sm w-full mx-auto space-y-8">
          ...
          {/* The Hero Button */}
          <button className="group relative flex items-center justify-center w-full gap-3 py-3 px-4 bg-zinc-100 text-zinc-950 rounded-lg font-medium transition-all duration-200 hover:bg-zinc-200 hover:scale-[1.01] active:scale-[0.99]">
      ...
      {/* RIGHT SIDE - The Visual Experience */}
